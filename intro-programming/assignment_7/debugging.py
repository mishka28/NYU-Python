...
if __name__ == '__main__':
    attraction = str(force_from_gravity(EARTH['mass'], SUN_MASS, EARTH['orbital_radius']))
    print("The force of attraction due to gravity between the earth and the sun")
    print("is: " + str(attraction))
